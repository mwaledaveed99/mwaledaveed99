...
roc_auc(lr_results, truth = diabetes, .pred_Yes)

```

```{r}
heatmap_lr<-conf_mat(lr_results, truth = diabetes, estimate = .pred_class) |> 
  autoplot(type = "heatmap")


mosaic_lr<-conf_mat(lr_results, truth = diabetes, estimate = .pred_class) |> 
