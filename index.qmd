...
- **Machine Learning with R**: Building predictive models using tidymodels. A highlight of this project is under the Machine Learning tab where i use bothe logistic regression and Random Forest models to predict diabetes.


## Skills

### Languages\n
- R : Proficient in data manipulation, visualisation and modelling with experience in reproducible workflows using RMarkdown, and Quarto.
